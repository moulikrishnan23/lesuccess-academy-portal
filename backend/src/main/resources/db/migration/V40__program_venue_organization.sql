...
ALTER TABLE program ADD COLUMN organization_name VARCHAR(120) NULL AFTER venue_address;
ALTER TABLE program ADD COLUMN venue_name VARCHAR(120) NULL AFTER organization_name;
