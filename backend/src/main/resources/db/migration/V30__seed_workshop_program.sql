...
INSERT IGNORE INTO program (type, label, title, topic, event_date, start_time, end_time, platform, meet_link, certificate_included, is_active, created_at, updated_at)
VALUES
