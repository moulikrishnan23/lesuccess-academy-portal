...
import in.lesuccess.portal.common.GlobalExceptionHandler;
import in.lesuccess.portal.security.JwtTokenProvider;
import in.lesuccess.portal.security.SecurityConfig;
import in.lesuccess.portal.security.JwtAuthenticationFilter;
import in.lesuccess.portal.security.CorsConfig;
    ...
    class GetByIdTests {
        ...
        void nonExistentId_shouldReturn404() throws Exception {
            when(contactService.getContactMessage(999L))
                    .thenThrow(new in.lesuccess.portal.common.ResourceNotFoundException("Contact message", 999L));
